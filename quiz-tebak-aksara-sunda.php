...
<body>
    ...
    <!-- Confirmation Popup -->
    <div id="confirmation-popup" class="popup-kembali" style="display: none;">
        <div class="popup-content-kembali">
            <p>Apakah Anda yakin ingin kembali ke halaman utama quiz?</p>
