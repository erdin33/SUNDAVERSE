...
<<<<<<< HEAD
    ...
    <div class="container">
        <div class="profile-card">
            ...
            <h2><?= $_SESSION['username']?><span class="edit-button" onclick >
            ...
            <p class="username"><?= $_SESSION['email']?><span class="edit-button">
            ...
            <div class="score-badge">Total skor: 500</div>
        </div>
...
>>>>>>> 812ecb230f538ccde6276922c09f7543f93310e0
    </div>
    <ul class="menu">
